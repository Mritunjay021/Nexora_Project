    ...
    return product && (
        ...
        className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-56 max-w-56 w-full">
            <div className="group cursor-pointer flex items-center justify-center px-2">
                <img className="group-hover:scale-130 transition max-w-26 md:max-w-36" src={product.image[0]} alt={product.name} />
            </div>
                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div className="text-primary" onClick={(e) => { e.stopPropagation(); }} >
                        {(!cartItems[product._id]) ? (
                            <button className="flex items-center justify-center gap-1 bg-primary/10 border border-primary/40 md:w-[80px] w-[64px] h-[34px] rounded font-medium cursor-pointer" 
